<nav class="bg-[#F9F9F9] shadow-md w-full p-3 transition-all duration-500 ease-in-out transform flex items-center justify-between z-50">
    ...
    <div class="md:hidden flex items-center">
     ...
     <!-- Mobile Menu -->
    <div id="mobile-menu" class="!z-50 fixed top-0 right-0 w-3/4 h-full bg-white shadow-lg transform translate-x-full transition-transform duration-300 ease-in-out z-50">
